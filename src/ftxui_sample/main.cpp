...
// configuration step. It creates a namespace called `crowbar`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", crowbar::cmake::project_name, crowbar::cmake::project_version) };
